...
DB_CONFIG = {
    ...
    'password': '',  # Intentionally no password per project configuration
    'autocommit': False,
    'raise_on_warnings': False,
    'charset': 'utf8mb4',
    'collation': 'utf8mb4_unicode_ci',
    'use_pure': True,  # Use pure Python implementation
    # Fail fast when MySQL is down to avoid UI lag (seconds)
    'connection_timeout': int(os.getenv('DB_TIMEOUT', '2'))
}
