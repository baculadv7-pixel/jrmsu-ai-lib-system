      ...
      <DropdownMenuContent align="end" className="w-64">
        ...
        <DropdownMenuSub>
          ...
          <DropdownMenuSubContent>
            ...
            <DropdownMenuItem onClick={() => { try { window.dispatchEvent(new CustomEvent('jrmsu:open-ai')); } catch {} }}>Study Helper</DropdownMenuItem>
            <DropdownMenuItem onClick={() => { try { window.dispatchEvent(new CustomEvent('jrmsu:system-guide')); } catch {} }}>System Guide</DropdownMenuItem>
            <DropdownMenuItem onClick={() => { try { window.dispatchEvent(new CustomEvent('jrmsu:open-support')); } catch {} }}>Technical Support</DropdownMenuItem>
            <DropdownMenuSeparator />
            <DropdownMenuItem className="flex items-center justify-between">
              <div className="flex items-center">
                <Volume2 className="mr-2 h-4 w-4" />
